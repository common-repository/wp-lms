...
class ParadisoLms_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'paradiso-lms'));
        }
        ...
        <div class="wrap">
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'paradiso-lms'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'paradiso-lms') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'paradiso-lms');
            case 'false':
                return __('false', 'paradiso-lms');

            case 'Administrator':
                return __('Administrator', 'paradiso-lms');
            case 'Editor':
                return __('Editor', 'paradiso-lms');
            case 'Author':
                return __('Author', 'paradiso-lms');
            case 'Contributor':
                return __('Contributor', 'paradiso-lms');
            case 'Subscriber':
                return __('Subscriber', 'paradiso-lms');
            case 'Anyone':
                return __('Anyone', 'paradiso-lms');
        }
        return $optionValue;
    }
